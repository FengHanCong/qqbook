  ...
  <div class="searchvn">
    <div class="header">
      <mu-appbar style="width: 100%;" color="transparent">
        <mu-button icon slot="left" @click="goback" style="color: #fff">
    ...
    <div class="input">
        <mu-text-field v-model="value" placeholder="请输入书名" @input="fuzzySearch"></mu-text-field>
        <mu-button color="blue" @click="goresult" style="color: #fff">搜索</mu-button>
    </div>
